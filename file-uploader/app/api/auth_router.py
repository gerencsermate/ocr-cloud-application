...
async def register_action(
    ...
    try:
        ...
        token = await auth_service.create_user(reg_data.username, reg_data.password, reg_data.as_admin)
...
async def login_action(
    ...
    try:
        ...
        token = await auth_service.get_token_for_user(login_data.username, login_data.password)
