...
class FileService:
    ...
    async def upload_file(self, uploaded_filename: str, file: BinaryIO, uploader_id: str, description: str) -> File:
        ...
        file = File(filename=new_filename, description=description, uploader=uploader_id)
