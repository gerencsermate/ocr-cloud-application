...
class Database:
    ...
    async def initialize(self):
        ...
        await init_beanie(database=self.client.db_name, document_models=[User])
        logger.info("MongoDB connected, db host: %s, db name: %s", {self.client.HOST}, {self.client.db_name})
